...
export class EventosComponent implements OnInit {
  ...
  boletin: EventosBienestar | null = null;
  boletines: EventosBienestar[] | null = null;
  ...
  constructor(
    ...
    private service: EventosBienestarService
  ) { }
  ...
  listarBoletines() {
    this.boletin = new EventosBienestar();
  ...
  cambiarEstado(event, id: number) {
    ...
    this.service.estadoEventos(this.boletin).subscribe(res => {
  ...
  confirmar() {
    ...
    if (this.accion == 'eliminar') {
      this.service.eliminarEventos(this.boletin).subscribe(res => {
        status = 200;
        console.log(res);
      ...
      this.service.guardarEventos(this.boletin).subscribe(res => {
        status = 200;
        console.log(res);
        this.alerta(this.accion, status)
      }, err => {
