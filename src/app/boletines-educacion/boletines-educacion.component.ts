...
@Component({
  selector: 'appcolp-boletines-educacion',
  templateUrl: './boletines-educacion.component.html',
  styleUrls: ['./boletines-educacion.component.css']
})
export class BoletinesEducacionComponent implements OnInit {
  ...
  constructor(
    ...
    private service: BoletinesEducacionService
  ) { }
